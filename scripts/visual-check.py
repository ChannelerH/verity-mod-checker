...
with sync_playwright() as playwright:
    ...
    for viewport_name, viewport in VIEWPORTS.items():
        ...
        assert "9,997" in verity_je_text
        assert "352,728" in verity_je_text
        ...
        assert "7,477,210" in mcpedl_text
        assert "303.0K" in mcpedl_text
        ...
        assert "303.0K" in pntmc_320_text
        ...
        assert "4,088,369" in verity_be_text
        assert "234.0K" in verity_be_text
        ...
        assert "352,728" in java_help_text
