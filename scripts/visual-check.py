...
with sync_playwright() as playwright:
    ...
    for viewport_name, viewport in VIEWPORTS.items():
        ...
        assert "366,354" in versions_text
        assert "21,380" in versions_text
        ...
        assert "21,380" in verity_je_text
        assert "366,354" in verity_je_text
        ...
        assert "7,498,066" in mcpedl_text
        assert "314.6K" in mcpedl_text
        ...
        assert "314.6K" in pntmc_320_text
        ...
        assert "4,096,382" in verity_be_text
        ...
        assert "366,354" in java_help_text
        ...
        page.locator("#supportProfile").fill("Forge 1.20.1 / Verity JE 6")
