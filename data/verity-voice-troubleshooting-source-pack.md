...
| --- | --- | --- |
| GSC | Delayed July 15 through July 28 report still shows 54 clicks, 1,640 impressions, 3.3% CTR, average position 8.7, and exact `verity mod` at 2 clicks / 3 impressions. | Keep homepage TDK stable; update source-backed support pages instead. |
