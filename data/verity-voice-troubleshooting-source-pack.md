...
| Smiley's Better Voice Java add-on | https://www.curseforge.com/minecraft/mc-mods/smileys-better-voice/files/8536538 | Project ID 1608717, main file Smiley's Better Voice-4.0.0.jar / 8536538, 101,091 project downloads and 2.8K file downloads at check. The file changelog says 4.0.0 supports Verity JE 6.0.0 and is incompatible with earlier Verity JE versions. | Use after the parent Verity JE route works; separate parent/add-on compatibility, Fish Audio, Cartesia, Better Voice toggle, Verity JE TTS toggle, and provider-key layers. |
