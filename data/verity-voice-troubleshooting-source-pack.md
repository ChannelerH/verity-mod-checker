...
| Verity BE Bedrock | https://www.curseforge.com/minecraft-bedrock/addons/verity-be/files/8583159 | Verity (Stable) (2.0.1)-(26.40).mcaddon / 8583159, July 31 hot fix. | Verify the current Bedrock MCADDON route before diagnosing local TTS, resource-pack audio, or voice behavior; old same-day record 8543534 is only old-link context and this is not live Java microphone input. |
