...
- Verity BE 2.0.1 source pack: https://veritymodchecker.online/data/verity-be-2-0-0-source-pack.md
- Public Verity BE 2.0.1 Gist copy: https://gist.github.com/ChannelerH/92901d32f1848ca2d737a237433dd23b
...
At the August 7 check, the Modrinth project showed:

- Project ID: `on1Y0osD`
- Project downloads: `569570`
- Followers: `206`
...
| --- | --- | --- | ---: | --- | --- | --- |
| 6.1 | `6jRN8Exp` | `verity-6.1.jar` | 80862 | Forge | 1.20.1 | beta |
| 6 | `CXsEzVwJ` | `verity-6.jar` | 69534 | Forge | 1.20.1 | beta |
| 5.7.3 | `yAt0wv1Z` | `verity-5.7.3.jar` | 344415 | Forge | 1.20.1 | release |
| 5.7.2 | `7qhItxce` | `verity-5.7.2.jar` | 41992 | Forge | 1.20.1 | release |
| 5.6.2 | `5QXbQ4rF` | `verity-5.6.2.jar` | 17001 | Forge | 1.20.1 | release |
...
At the August 7 check, the project page showed:

- Project name: Verity JE
- Owner: `VarmiteYT`
- Project ID: `1591438`
- Project downloads: `2871128`
- Main file: `verity-6.1.jar`
- Main file record: `8555265`
- Main file downloads: `155.8K`
...
At the August 7 check:

- Owner: `Undertaletalelover`
- Project ID: `1574632`
- Project downloads: `4698808`
- Current file: `Verity (Stable) (2.0.1)-(26.40).mcaddon`
- File record: `8583159`
- File downloads: `66.3K` displayed at the check
- File size: `23.7 MB`
- Supported build: `26.30`
- What's new: Hotfix for 26.40.
- Setup notes: enable Beta APIs, run the route-specific connect command, use cheats, and type `Verity` before the chat message.
- Previous visible Stable 2.0.0 hot-fix route: record `8544453`, remains useful for old tutorials and cached snippets but is not the current hot fix recommendation.
- Earlier same-day 2.0.0 route: record `8543534`, remains useful for old-link diagnosis when a cached answer names that exact file.
- Previous visible 1.1.0 route: record `8506198`, `Verity (Stable) (1.1.0)-(26.3).mcaddon`, remains useful for old-video and old-file diagnosis but is no longer the current file recommendation.
...
- Owner: `PnTMC`
- Project ID: `1575941`
- CurseForge project downloads: `8738315`
- MCPEDL displayed listing downloads: `8.7M`
...
| --- | ---: | ---: | ---: | --- |
| `ThatMob's Verity 3.2.0 by PnTMC [Add-on] - V26.30.mcaddon` | 8517480 | 975.2K | 39.6 MB | 2026-07-27 |
