...
- Verity Pack / modpack route: separates CurseForge modpacks `Verity Pack`, `VerityPack`, `VerityPack Realistic`, and `Survive from VERITY or FALSITY` from the standalone Verity JE file, FALSITY [SMILEY], and Bedrock add-ons, including Project IDs `1583377`, `1587394`, `1596649`, and `1583260`.
- Verity Dweller / similar-name route: separates Modrinth `Verity Dweller` Project ID `eZW2ZX0U`, `Horrorland - With Verity!` Project ID `mJcQB7OR`, and generic Paper plugin Project ID `DYiZP3fM` from the current Verity Mod Java and Bedrock download routes.
