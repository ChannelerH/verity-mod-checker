...
- Versions route: answers `Verity Mod versions`, `all versions`, `Verity Mod requirements`, Java version, Bedrock version, and MCPE version searches with a single source-checked matrix; it separates Modrinth Verity JE 6 / `CXsEzVwJ` / `verity-6.jar`, CurseForge and Modrinth 5.7.3, stale 6.0.1 and 6.0.0 beta links, legacy 3.4.1, Verity BE 1.1.0, PnTMC 3.2.0, old PnTMC rows, Pocket Edition, Java loader requirements, Bedrock build requirements, and a public Gist source pack.
